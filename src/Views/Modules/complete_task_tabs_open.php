...
<div id="tab-container" class="tab-container">
    <ul class="etabs">
        <li class="tab <?php echo $tab[\Puzzlout\WebIde\Resources\Enums\TaskTabKeys::CompleteInfoTab]; ?>" data-form-id="task_status">
        ...
        <li class="tab <?php echo $tab[\Puzzlout\WebIde\Resources\Enums\TaskTabKeys::CompleteTaskMapTab]; ?>" data-form-id="live_task_map">
            <a href="<?php echo FrameworkConstants_BaseUrl . \Library\Enums\UrlKeys::CompleteTaskMap; ?>">
                <?php echo $resx["task_tab_map"]; ?>
            </a>
        </li>
        <li class="tab <?php echo $tab[\Puzzlout\WebIde\Resources\Enums\TaskTabKeys::CompleteInspFormsTab]; ?>" id="tab2" data-form-id="live_task_insp_info">
        ...
        <li class="tab <?php echo $tab[\Puzzlout\WebIde\Resources\Enums\TaskTabKeys::CompleteTaskServicesTab]; ?>" id="tab7" data-form-id="live_task_services">
