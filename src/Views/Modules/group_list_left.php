...
<div class="scroll-bar">
    <ol id="group-list-left" class="list-panel">
        <?php
        foreach ($data_left[\Puzzlout\WebIde\Resources\Enums\ViewVariablesKeys::objects_list_left] as $object) {
            $prop_name = $data_left
            ...
            echo
            "<li data-" . $data_left[\Puzzlout\WebIde\Resources\Enums\ViewVariablesKeys::module] . "-id=\"" . $object->$prop_id() . "\" class=\"select_item ui-widget-content\">"
            . $object->$prop_name()
            . "</li>";
        }
        ?>              
